...
typedef FlashListViewDelegateOnItemKey = String Function(int index);
typedef FlashListViewDelegateOnItemSticky = bool Function(int index);
typedef FlashListViewDelegateOnItemHeight = double Function(int index);

enum FirstItemAlign { start, end }

class FlashListViewDelegate extends SliverChildDelegate {
  ...
  final FlashListViewDelegateOnItemKey? onItemKey;

  /// Optional callback to locate a child index by key after list mutations.
  ...
  final FlashListViewDelegateOnItemSticky? onItemSticky;
  ...
  final FlashListViewDelegateOnItemHeight? onItemHeight;
  ...
  FlashListViewDelegate copyWith({
    ...
    FlashListViewDelegateOnItemKey? onItemKey,
    ChildIndexGetter? findChildIndexCallback,
    bool? keepPosition,
    double? keepPositionOffset,
    FlashListViewDelegateOnItemSticky? onItemSticky,
    bool? stickyAtTailer,
    FlashListViewDelegateOnItemHeight? onItemHeight,
    double? preferItemHeight,
    FirstItemAlign? firstItemAlign,
    int? initIndex,
    int? forceToExecuteInitIndex,
    double? initOffset,
    bool? initOffsetBasedOnBottom,
    bool Function(String keyOrIndex)? onIsPermanent,
    bool? isSupressElementGenerate,
    bool? disableCacheItems,
    bool? expandDirectToDownWhenFirstItemAlignToEnd,
  }) {
    return FlashListViewDelegate(
      ...
      onItemKey: onItemKey ?? this.onItemKey,
      findChildIndexCallback:
          findChildIndexCallback ?? this.findChildIndexCallback,
      keepPosition: keepPosition ?? this.keepPosition,
      keepPositionOffset: keepPositionOffset ?? this.keepPositionOffset,
      onItemSticky: onItemSticky ?? this.onItemSticky,
      stickyAtTailer: stickyAtTailer ?? this.stickyAtTailer,
      onItemHeight: onItemHeight ?? this.onItemHeight,
      preferItemHeight: preferItemHeight ?? this.preferItemHeight,
      firstItemAlign: firstItemAlign ?? this.firstItemAlign,
      initIndex: initIndex ?? this.initIndex,
      forceToExecuteInitIndex:
          forceToExecuteInitIndex ?? this.forceToExecuteInitIndex,
      initOffset: initOffset ?? this.initOffset,
      initOffsetBasedOnBottom:
          initOffsetBasedOnBottom ?? this.initOffsetBasedOnBottom,
      onIsPermanent: onIsPermanent ?? this.onIsPermanent,
      isSupressElementGenerate:
          isSupressElementGenerate ?? this.isSupressElementGenerate,
      disableCacheItems: disableCacheItems ?? this.disableCacheItems,
      expandDirectToDownWhenFirstItemAlignToEnd:
          expandDirectToDownWhenFirstItemAlignToEnd ??
          this.expandDirectToDownWhenFirstItemAlignToEnd,
    );
  }
  ...
  @override
  bool shouldRebuild(covariant FlashListViewDelegate oldDelegate) {
    return builder != oldDelegate.builder ||
        ...
        semanticIndexOffset != oldDelegate.semanticIndexOffset ||
        semanticIndexCallback != oldDelegate.semanticIndexCallback ||
        onItemKey != oldDelegate.onItemKey ||
        findChildIndexCallback != oldDelegate.findChildIndexCallback ||
        keepPosition != oldDelegate.keepPosition ||
        keepPositionOffset != oldDelegate.keepPositionOffset ||
        onItemSticky != oldDelegate.onItemSticky ||
        stickyAtTailer != oldDelegate.stickyAtTailer ||
        onItemHeight != oldDelegate.onItemHeight ||
        preferItemHeight != oldDelegate.preferItemHeight ||
        firstItemAlign != oldDelegate.firstItemAlign ||
        initIndex != oldDelegate.initIndex ||
        forceToExecuteInitIndex != oldDelegate.forceToExecuteInitIndex ||
        initOffset != oldDelegate.initOffset ||
        initOffsetBasedOnBottom != oldDelegate.initOffsetBasedOnBottom ||
        onIsPermanent != oldDelegate.onIsPermanent ||
        isSupressElementGenerate != oldDelegate.isSupressElementGenerate ||
        disableCacheItems != oldDelegate.disableCacheItems ||
        expandDirectToDownWhenFirstItemAlignToEnd !=
            oldDelegate.expandDirectToDownWhenFirstItemAlignToEnd;
  }
}
